		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover is-light has-custom-content-position is-position-bottom-left vsg-big-card vsg-big-card--half" style="min-height:520px">
				...
				<div class="wp-block-cover__inner-container">
					<!-- wp:group {"className":"vsg-maxw-400","style":{"spacing":{"blockGap":"var:preset|spacing|30","padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"672px","justifyContent":"left"}} -->
					<div class="wp-block-group vsg-maxw-400" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
